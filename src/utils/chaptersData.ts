...
export const rawChapters: RawChapter[] = [
  {
    ...
    category: "Overview",
    content: "TidyFlow is the operating system for cleaning companies — schedule jobs, verify work on-site, message your team, sync invoices to QuickBooks, pay your team, and prove quality to clients, all in one platform. Built for residential and commercial cleaning teams, it connects owners, managers, and cleaners with scheduling, GPS-verified job tracking, per-task team chat with voice notes, company announcements, photo proof, payroll, client reports, Revenue AI insights, and offline-first field tools. By replacing paper checklists, WhatsApp chaos, and separate payroll spreadsheets, TidyFlow gives you one secure, multi-tenant SaaS platform with role-based access, self-serve subscription billing, Google Sheets two-way sync, QuickBooks Online invoice sync, an Integrations hub, and support for 11 languages (including Arabic RTL).",
    mockupType: "pdf"
  },
  {
    id: "ch-2",
    ...
    category: "Overview",
    content: "To initiate operations, company admins can sign up for a TidyFlow portal, establishing their business record. Upon first install, staffers encounter an interactive feature onboarding tour explaining primary modules. Once activated, owners are guided to choose a Startup, Standard, or Premium plan (14-day free trial available). From there, owners can invite staff by accessing Users inside the Sidebar, entering worker names, emails, and role categories (Managers or Cleaners) to dispatch login credentials immediately. Next connect Google Sheets if you use a master spreadsheet, set your company country for address autocomplete, and open the Integrations hub to confirm Sheets, and optionally QuickBooks are healthy."
  },
  {
    id: "ch-3",
    num: 3,
  ...
  },
  {
    ...
    category: "Role Guides",
    content: "Owners have master authority across business accounts. Upon login, owners access Billing (current plan, usage meters, upgrade/downgrade, cancel trial or paid plan), manage your TidyFlow subscription, customize corporate branding layouts (logo embeds, bank details, and receipt headers), connect QuickBooks Online for client invoice sync, and audit multi-user logs. Owners can also open the Revenue dashboard for net profit, cash collected, expenses, and margins by property or client — then run Revenue AI analysis for a plain-language explanation of what changed. Use the Integrations hub to monitor Sheets, QuickBooks, and Maps health, and broadcast company announcements when the whole team needs one message."
  },
  {
    id: "ch-11",
    num: 11,
  ...
  },
  {
    ...
    category: "Advanced",
    content: "The Integrations hub (owners/admins) shows connection health for Google Sheets, QuickBooks Online, and maps — plus recent sync activity and one-tap reconnect when a token expires. Google Sheets: two-way master Properties + Tasks sync with webhook push and write-back of status and assignees. QuickBooks Online: OAuth connect once, then sync client invoices with customers, line items, and totals (single or bulk). Optional automation can sync on create, send (email/WhatsApp), or mark-paid; approved payroll can sync as vendor bills on supported plans. Google Maps & Places: map pins, geofence, routing, and country-scoped address autocomplete. Website /integrations explains partner tools; the in-app Integrations hub is the live connection panel."
  },
  {
    id: "ch-26",
    num: 26,
