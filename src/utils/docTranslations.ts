// Localization dictionary for the User Guide and TidyBot documentation chatbot across all 11 supported languages.
...
export const portalTranslations: Record<string, DocPortalTranslation> = {
  en: {
    ...
    clearBtn: "Clear",
    chaptersCount: "Chapter {num} of {total}",
  ...
  pt: {
    ...
    clearBtn: "Limpar",
    chaptersCount: "Capítulo {num} de {total}",
    ...
    botSubtitle: "Treinado nos capítulos do guia do Guia",
    botGreeting: "Olá! 👋 Sou o **TidyBot** — seu guia amigável do TidyFlow.\n\nPergunte sobre configuração, **Google Sheets**, modo offline, folha de pagamento, quem fundou o TidyFlow ou qualquer um dos **capítulos do guia**. Use um botão rápido abaixo! 🧹",
    botSearching: "Analisando o Guia do Usuário...",
    botFallback: "Não encontrei uma correspondência direta em nossos capítulos do guia. Experimente pesquisar por tópicos como:\n\n• **\"Google Sheets\"** para aprender sobre sincronização em tempo real.\n• **\"Offline\"** para ler sobre operações sem sinal.\n• **\"SOS\"** para ver alertas de emergência.\n• **\"Folha de pagamento\"** para aprovação de horas.",
  ...
  es: {
    ...
    botSubtitle: "Entrenado en los capítulos do guia de la Guía",
    botGreeting: "¡Hola! 👋 Soy **TidyBot**, tu guía amigable de TidyFlow.\n\nPregúntame sobre configuración, **Google Sheets**, modo offline, nómina, quién fundó TidyFlow o cualquiera de los **capítulos do guia**. ¡Prueba un botón rápido abajo! 🧹",
    botSearching: "Analizando la Guía del Usuario...",
    botFallback: "No encontré una coincidencia directa en nuestros capítulos do guia. Intenta buscar temas como:\n\n• **\"Google Sheets\"** para aprender sobre la sincronización en vivo.\n• **\"Offline\"** para leer sobre operaciones sin señal celular.\n• **\"SOS\"** para ver alertas de pánico.\n• **\"Nómina\"** para verificar la aprobación de horas de trabajo.",
  ...
  ar: {
    ...
    clearBtn: "مسح",
    chaptersCount: "الفصل {num} من أصل {total}",
  ...
  cn: {
    ...
    clearBtn: "清除",
    chaptersCount: "第 {num} 章 / 共 {total} 章",
    hideTOC: "隐藏章节目录清单",
    showTOC: "展开章节目录清单",
    categoryLabel: "分类模块:",
    printBtn: "打印当前章节",
    ...
    botSubtitle: "已深度整合用户手册",
    botGreeting: "您好！👋 我是 **TidyBot** — 您友好的 TidyFlow 向导。\n\n可咨询配置、**Google 表格**、离线模式、工资结算、TidyFlow 创始人，或 **用户手册章节**任意内容。点击下方快捷按钮试试！🧹",
    botSearching: "正在深入分析用户指南数据库...",
    botFallback: "很抱歉，在 官方用户手册章节中未找到完全匹配的结果。推荐您搜索以下核心词汇：\n\n• **“Google Sheets”** 了解电子表格同步。\n• **“离线”** 了解地下室断网工作机制。\n• **“SOS”** 查看安全警报流程。\n• **“工资”** 了解如何审核工时发放薪酬。",
  ...
  fr: {
    ...
    clearBtn: "Effacer",
    chaptersCount: "Chapitre {num} de {total}",
    ...
    botSubtitle: "Formé sur les chapitres du guide de l'Aide",
    botGreeting: "Bonjour ! 👋 Je suis **TidyBot** — votre guide TidyFlow.\n\nPosez-moi des questions sur la config, **Google Sheets**, le mode hors ligne, la paie, le fondateur de TidyFlow ou l'un des **chapitres du guide**. Essayez un bouton ci-dessous ! 🧹",
  ...
  de: {
    ...
    clearBtn: "Leeren",
    chaptersCount: "Kapitel {num} von {total}",
    ...
    botSubtitle: "Geschult auf allen Handbuch-Kapiteln",
    botGreeting: "Hallo! 👋 Ich bin **TidyBot** — dein freundlicher TidyFlow-Guide.\n\nFrag mich zu Setup, **Google Sheets**, Offline-Modus, Lohn, Gründer von TidyFlow oder einem der **Handbuch-Kapiteln**. Probier einen Schnellbutton! 🧹",
  ...
  pl: {
    ...
    clearBtn: "Wyczyść",
    chaptersCount: "Rozdział {num} z {total}",
    ...
    botSubtitle: "Przeszkolony na rozdziałach przewodnika Pomocy",
    botGreeting: "Cześć! 👋 Jestem **TidyBot** — Twój przyjazny przewodnik TidyFlow.\n\nZapytaj o konfigurację, **Google Sheets**, tryb offline, płace, założyciela TidyFlow lub którykolwiek z **rozdziałów przewodnika**. Wypróbuj szybki przycisk! 🧹",
  ...
  no: {
    ...
    clearBtn: "Nullstill",
    chaptersCount: "Kapittel {num} av {total}",
    ...
    botSubtitle: "Trent på brukerveiledningen",
    botGreeting: "Hei! 👋 Jeg er **TidyBot** — din vennlige TidyFlow-guide.\n\nSpør om oppsett, **Google Sheets**, offline-modus, lønn, hvem som grunnla TidyFlow, eller et av **brukerkapitlene**. Prøv en hurtigknapp! 🧹",
  ...
  sv: {
    ...
    clearBtn: "Rensa",
    chaptersCount: "Kapitel {num} av {total}",
    ...
    botSubtitle: "Utbildad på samtliga guidekapitel",
    botGreeting: "Hej! 👋 Jag är **TidyBot** — din vänliga TidyFlow-guide.\n\nFråga om inställningar, **Google Sheets**, offline-läge, lön, vem som grundade TidyFlow, eller något av **guiden**. Prova en snabbknapp! 🧹",
  ...
  it: {
    ...
    clearBtn: "Svuota",
    chaptersCount: "Capitolo {num} di {total}",
    ...
    botSubtitle: "Istruito su i capitoli della guida utente",
    botGreeting: "Ciao! 👋 Sono **TidyBot** — la tua guida amichevole TidyFlow.\n\nChiedimi di configurazione, **Google Sheets**, modalità offline, paghe, chi ha fondato TidyFlow o uno dei **capitoli della guida**. Prova un pulsante rapido! 🧹",
...
// Complete translated text database for guide chapters in all 11 supported languages.
