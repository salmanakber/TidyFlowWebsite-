...
export const portalTranslations: Record<string, DocPortalTranslation> = {
  en: {
    ...
    botName: "TidyBot",
    botSubtitle: "Trained on product, pricing & 23 guide chapters",
    ...
    botConnectionError: "Sorry, I'm having trouble connecting right now 😅 ({error}). Try asking who founded TidyFlow, about pricing, or browse the User Guide!",
    askPlaceholder: "Ask about features, pricing, demo, or docs...",
